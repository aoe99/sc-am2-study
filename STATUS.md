...
| 枠だけを600dpiで読み直す（2026-09-06） | **効いた。** 記号入りが589→768個。採用時の正確さ97% |
...
**本文の空欄の枠は、記号が読めているものが768個、読めていないものが888個。** 素直に
...
**枠だけを600dpiで切り出して読み直すと、記号は589個から768個になった。**
...
285/427。残りは範囲表記（「［a］～［e］」の2枠に対しラベルは5つ）が大半。
