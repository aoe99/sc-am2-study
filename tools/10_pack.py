...
the 300dpi crops — at 1000px wide and JPEG q60 the densest table in the corpus drops
from 1.0MB to 123KB and stays fully readable, which is what keeps the pack
openable on a phone.
